...
void addmedi()
{
    ...
    //  scanf("%[^\n]*c",t1.name);
     scanf("%s", &t1.name);
    // fgets(t1.name,50,stdin);
    printf("\nEnter price:");
    scanf("%d", &t1.price);
    printf("\nEnter Company name:");
    // scanf("%[^\n]%*c",t1.company);
    // fgets(t1.company,50,stdin);
     scanf("%s", &t1.company);
    printf("\nEnter generic name :");
    // scanf("%[^\n]%*c",t1.genaric);
    // fgets(t1.genaric,50,stdin);
     scanf("%sw", &t1.genaric);
...
void search()
{
    ...
    while (1)
    {
        ...
        if (strcmp(name, t.name) == 0)
        {
            ...
            printf("Medicine_Name\tmedicine_price\tGenaric name\tCompany name\n\n");
...
void displayAll()
{
    ...
    printf("\nSerial no\tName\t\t Price\t\tGeneric Name\t\tCompany Name\n\n");
